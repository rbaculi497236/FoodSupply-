    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            if (!string.IsNullOrWhiteSpace(user.PasswordHash))
            {
                try
                {
                    // First try it as an ASP.NET Core password hash.
                ...
                {
                    // The database contains an old plain-text password.
                    passwordValid = false;
                }
            }
                ...
                user.PasswordHash == model.Password)
            {
                ...
                // Immediately convert the old password
                // into a secure ASP.NET Core password hash.
                user.PasswordHash =
                    _passwordHasher.HashPassword(
                        user,
                        model.Password
